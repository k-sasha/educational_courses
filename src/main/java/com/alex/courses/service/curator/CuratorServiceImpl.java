...
public class CuratorServiceImpl implements CuratorService {
    ...
    @Override
    public CuratorRequestDto save(CuratorRequestDto curatorDto) {
    ...
    @Override
    public CuratorResponseDto get(Long id) {
    ...
    @Override
    public CuratorUpdateDto update(Long id, CuratorUpdateDto updatedCuratorDto) {
